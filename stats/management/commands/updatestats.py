    ...
    for root, dirs, files in os.walk(dir_path):
        for file in files:
            if file not in exclusions:
                ...
                mod_date = datetime.datetime.utcfromtimestamp(
...
def update_models(key, pilot, filename, mission, stats_json, date, in_process):
            ...
            for client in stats_json:
                ...
                if client != "d3e5193a19b7b4a5b3468492c7184a63":
                    ...
                    try:
                        ...
                        new_pilot = Pilot.objects.create(
                            clientid=client, callsign=callsign
                        )
...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        if options["deletemission"]:
            ...
            while not valid:
                cont = input(
                    "This will remove all stats data from the database"
