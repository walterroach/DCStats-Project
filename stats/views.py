	...
	try:
		...
		if request.method == 'POST':
			...
			if form.is_valid():
				...
				return render(request, 'stats/leaderboard.html', {'form':form,'stats':stats, 'start_date':start_date.date, 'end_date':end_date.date})
		else:
			...
			form = StatsOptions(initial={'group_by':['pilot__callsign'], 'start_date':start_date.date(), 'end_date':end_date.date()})
